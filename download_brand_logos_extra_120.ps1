...
$ManifestPath = Join-Path $Root "brand_logos_extra_120_manifest.json"

if (!(Test-Path $ManifestPath)) {
    throw "brand_logos_extra_120_manifest.json not found beside this script."
}

$OutputDir = Join-Path $Root "public\assets\question-images\brand-logos-extra"
...
$FailuresPath = Join-Path $Root "brand_logos_extra_120_failed_downloads.json"
